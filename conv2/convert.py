...
images, labels = load_mnist("training", digits=None, path='/home/rik/deeplearning/data')    
...
for x in range(0, len(images)):
    imagesTrain.append(np.reshape(images[x], (28*28)))
    
np.save('trainImages.npy', imagesTrain)
np.save('trainLabels.npy', labels)


images, labels = load_mnist("testing", digits=None, path='/home/rik/deeplearning/data')    
...
np.save('validImages.npy', imagesTrain)
